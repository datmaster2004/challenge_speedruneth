...
const deployedContracts = {
  ...
  11155111: {
    DEX: {
      address: "0x3bf1cb73f7Cc111AAF03C4B9Ec3022B1b1deEb84",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9947333,
    },
    MyUSD: {
      address: "0x81F747Ed92257B1b168b8d760a29A746f525E2c2",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9947332,
    },
    MyUSDEngine: {
      address: "0xEB3510AE27cA145fe4dA7A99B95326c75d7129B1",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9947343,
    },
    MyUSDStaking: {
      address: "0x3885D2Bcfb4DA9c6abeCD6034d970013687245B5",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9947337,
    },
    Oracle: {
      address: "0xEd193d88916107Be75916aBbd52421021a08f67b",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9947334,
    },
    RateController: {
      address: "0xB95A912373130fb9883381B4a3CE3b4C6003A9F0",
      abi: [
        {
          inputs: [
            {
