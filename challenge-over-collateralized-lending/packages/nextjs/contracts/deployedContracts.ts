...
const deployedContracts = {
  ...
  11155111: {
    Corn: {
      address: "0x2630d06774914c9a055b6f85c5696fe3d4c8e372",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: "0x97c821",
    },
    CornDEX: {
      address: "0x27f4Bfd1b4D20cD4FB822791a0c954583E9b587E",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9947172,
    },
    Lending: {
      address: "0x118f69aDf831FbcF0e123c3861380818F45bfdA4",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9947173,
    },
    MovePrice: {
      address: "0xc5B503251C20c0FfE8F7Ee362CbA050F3283F6f9",
      abi: [
        {
          inputs: [
            {
